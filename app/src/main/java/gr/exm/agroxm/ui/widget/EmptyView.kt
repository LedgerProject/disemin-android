package gr.exm.agroxm.ui.widget
...
import gr.exm.agroxm.databinding.ViewEmptyBinding
...
class EmptyView : LinearLayout {
    ...
    fun subtitle(@StringRes res: Int): EmptyView {
        binding.subtitle.text = resources.getString(res)
        return this
    }
    ...
    fun animation(@RawRes res: Int): EmptyView {
    ...
    fun action(@StringRes res: Int): EmptyView {
        binding.action.text = resources.getString(res)
        return this
    }
